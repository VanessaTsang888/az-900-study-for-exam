...
- Web apps
- API apps
- WebJobs: a feature of Azure Service that enables you to run a program or script in the same instance as a web app, API app or mobile app. No extra cost to use WebJobs.
- Mobile apps.
